...
export interface master_token_offering_statusAttributes {
  id: number;
  name?: string;
  is_active?: boolean;
  created_at?: Date;
...
export type master_token_offering_statusPk = "id";
export type master_token_offering_statusId = master_token_offering_status[master_token_offering_statusPk];
export type master_token_offering_statusOptionalAttributes = "id" | "name" | "is_active" | "created_at" | "updated_at";
export type master_token_offering_statusCreationAttributes = Optional<master_token_offering_statusAttributes, master_token_offering_statusOptionalAttributes>;

export class master_token_offering_status extends Model<master_token_offering_statusAttributes, master_token_offering_statusCreationAttributes> implements master_token_offering_statusAttributes {
  id!: number;
  name?: string;
  is_active?: boolean;
  created_at?: Date;
  ...
  // master_token_offering_status hasMany token_offering via offer_status_id
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof master_token_offering_status {
    return master_token_offering_status.init({
    id: {
      autoIncrement: true,
    ...
    sequelize,
    tableName: 'master_token_offering_status',
    schema: 'public',
    timestamps: true,
    ...
    indexes: [
      {
        name: "master_token_offering_status_pkey",
        unique: true,
        fields: [
          { name: "id" },
        ]
