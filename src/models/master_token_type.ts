...
export interface master_token_typeAttributes {
  id: number;
  name?: string;
  is_active?: boolean;
  created_at?: Date;
...
export type master_token_typePk = "id";
export type master_token_typeId = master_token_type[master_token_typePk];
export type master_token_typeOptionalAttributes = "id" | "name" | "is_active" | "created_at" | "updated_at";
export type master_token_typeCreationAttributes = Optional<master_token_typeAttributes, master_token_typeOptionalAttributes>;

export class master_token_type extends Model<master_token_typeAttributes, master_token_typeCreationAttributes> implements master_token_typeAttributes {
  id!: number;
  name?: string;
  is_active?: boolean;
  created_at?: Date;
  ...
  // master_token_type hasMany token_offering via token_type_id
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof master_token_type {
    return master_token_type.init({
    id: {
      autoIncrement: true,
