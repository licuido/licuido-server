...
export type entity_investorOptionalAttributes = "id" | "investor_type_id" | "investor_entity_id" | "individual_investor_id" | "status_id" | "is_active" | "created_by" | "updated_by" | "created_at" | "updated_at" | "issuer_entity_id";
...
export class entity_investor extends Model<entity_investorAttributes, entity_investorCreationAttributes> implements entity_investorAttributes {
  ...
  // entity_investor belongsTo entity via issuer_entity_id
