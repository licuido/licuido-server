import { master_blockchain_network } from "@models";
import { Op } from "sequelize";

class MasterBlockChainNetworks {
  /**
  ...
  static async findAll(options: {
    ...
    try {
      ...
      const { rows, count } = await master_blockchain_network.findAndCountAll({
        where: {
          is_active: true,
...
export { MasterBlockChainNetworks };
