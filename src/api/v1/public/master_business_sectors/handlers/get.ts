...
import { MasterBusinessSectors } from "interactors";
import { queryRequestInfo } from "@mappers";
import { preparePagination } from "serializers/getResponse";

//GET_ALL_BUSINESS_SECTORS
export async function GET_ALL_BUSINESS_SECTORS(
  ...
  try {
    ...
    //  INTRACTOR
    // -----------------------------
    const result = await MasterBusinessSectors.getAllMasterBusinessSectorsList({
      search,
      offset,
      limit,
      ...rest,
