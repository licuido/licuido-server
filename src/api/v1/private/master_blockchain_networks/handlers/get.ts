...
export async function GET_ALL_BLOCK_CHAIN_NETWORKS(
  ...
  try {
    ...
    //  INTRACTOR
    // -----------------------------
    const result = await MasterBlockChainNetwork.getAllMasterBlockChainList({
      search,
      offset,
      limit,
      ...rest,
